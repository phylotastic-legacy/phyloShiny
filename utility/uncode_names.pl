...
This script was made specifically to convert the trees from Goloboff, et al 2009 (Cladistics 2009, 25:211-230) so we could use them phylotastically.   It represents the last step in a 3-step process: 
